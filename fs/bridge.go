...
// As a workaround, the sharded maps backing stableAttrs and kernelNodeIds
// rebuild their per-shard tables when they have shrunk dramatically
// (see shardedmap.go for the shrink threshold and rate-limit).
